...
RUN apt-get update && \
    ...
    ca-certificates curl iputils-ping python3 python-is-python3 ripgrep ffmpeg gcc g++ make build-essential python3-dev python3-venv libffi-dev libolm-dev procps git openssh-client openssh-server docker-cli xz-utils && \
